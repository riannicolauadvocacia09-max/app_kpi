...
export const HeaderView: React.FC<HeaderViewProps> = ({ onReset, onOpenImportModal, activeTab, setActiveTab }) => {
        ...
        <div className="flex flex-col md:flex-row items-center justify-between py-4 gap-4">
          ...
          <div className="flex items-center gap-2 sm:gap-3">
            ...
            <button
              ...
              title="Sincronizar com Google Sheets ou carregar dados"
            >
